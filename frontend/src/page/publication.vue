        ...
        <div class="row g-4 mt-3">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm" style="background-color: #f8ffe7">
              ...
              <div class="card-footer border-0 pb-3" style="background-color: #f8ffe7">
                <router-link to="/publications/1" class="btn btn-sm btn-outline-success d-flex align-items-center" style="width: fit-content;">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm" style="background-color: #f8ffe7">
              ...
              <div class="card-footer border-0 pb-3" style="background-color: #f8ffe7">
                <router-link to="/publications/2" class="btn btn-sm btn-outline-success d-flex align-items-center" style="width: fit-content;">
                  Read More <i class="bi bi-arrow-right ms-1"></i>
                </router-link>
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm" style="background-color: #f8ffe7">
              ...
              <div class="card-footer border-0 pb-3" style="background-color: #f8ffe7">
                <router-link to="/publications/3" class="btn btn-sm btn-outline-success d-flex align-items-center" style="width: fit-content;">
                  Read More <i class="bi bi-arrow-right ms-1"></i>
                </router-link>
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm" style="background-color: #f8ffe7">
              ...
              <div class="card-footer border-0 pb-3" style="background-color: #f8ffe7">
                <router-link to="/publications/4" class="btn btn-sm btn-outline-success d-flex align-items-center" style="width: fit-content;">
                  Read More <i class="bi bi-arrow-right ms-1"></i>
                </router-link>
              </div>
            </div>
